% updatem-226(SECTION) | User Commands
%
% "June  5 2024"
...
updatem-226 - program to do something

# SYNOPSIS

**updatem-226** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**updatem-226** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **updatem-226** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**updatem-226** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    updatem-226. See **foo.conf**(5) for further details.
...
**updatem-226** provides some return codes, that can be used in scripts:
...
Michael <idigitallegacy@yandex.ru>
